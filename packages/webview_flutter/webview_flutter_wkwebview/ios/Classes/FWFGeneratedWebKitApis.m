...
- (void)decidePolicyForNavigationResponseForDelegateWithIdentifier:(NSNumber *)arg_identifier webViewIdentifier:(NSNumber *)arg_webViewIdentifier navigationResponse:(FWFWKNavigationResponseData *)arg_navigationResponse completion:(void (^)(FWFWKNavigationResponsePolicyEnumData *_Nullable, FlutterError *_Nullable))completion {
  FlutterBasicMessageChannel *channel =
    [FlutterBasicMessageChannel
