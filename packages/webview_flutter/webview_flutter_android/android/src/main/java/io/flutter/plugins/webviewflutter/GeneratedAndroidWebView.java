...
public class GeneratedAndroidWebView {
  ...
  public static class WebViewClientFlutterApi {
    ...
    public void onPageError(@NonNull Long instanceIdArg, @NonNull Long webViewInstanceIdArg, @NonNull Long statusCodeArg, @NonNull Reply<Void> callback) {
      BasicMessageChannel<Object> channel =
          new BasicMessageChannel<>(
              binaryMessenger, "dev.flutter.pigeon.webview_flutter_android.WebViewClientFlutterApi.onPageError", getCodec());
      channel.send(
          new ArrayList<Object>(Arrays.asList(instanceIdArg, webViewInstanceIdArg, statusCodeArg)),
          channelReply -> callback.reply(null));
    }
